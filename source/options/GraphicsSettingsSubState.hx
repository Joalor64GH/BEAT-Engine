...
class GraphicsSettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		var option:Option = new Option('Screen Resolution', "Size of the window (Changes will apply once leaving)", 'screenRes', 'string', '1280 x 720',
			['1280 x 720', '1280 x 960', 'FULLSCREEN']);
		addOption(option);
